...
def readparams():
    ...
    return pars,srcinps,bus_arr,genbus_ind,loadbus_ind,loadbus_no_arr,genbus_no_arr

pars,srcinps,bus_arr,genbus_ind,loadbus_ind,loadbus_no_arr,genbus_no_arr = readparams()
